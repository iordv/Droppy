...
struct MenuBarManagerExtension: ExtensionDefinition {
    ...
    static let description = "Hide unused menu bar icons and reveal them with a click. Keep your menu bar clean and organized with always-visible, auto-hide, and always-hidden Floating Bar (Alpha) preferences."
    ...
    static let features: [(icon: String, text: String)] = [
        ...
        ("eye.slash", "Always hidden icons in Floating Bar (Alpha)")
    ]
