...
struct CaffeineInfoView: View {
    ...
    @State private var selectedMode: CaffeineMode = .both
        ...
        VStack(spacing: 16) {
            ...
            HStack {
                ...
                Button {
                    ...
                    Image(systemName: caffeineManager.isActive ? "power" : "power")
                }
            ...
            VStack(spacing: 0) {
                ForEach(Array(CaffeineMode.allCases.enumerated()), id: \.element) { index, mode in
                    Button {
                        ...
                        .padding(12)
                        .background(selectedMode == mode ? AdaptiveColors.buttonBackgroundAuto : Color.clear)
                    }
                    .buttonStyle(.plain)
